...
#plt.ylim([0,1.1])
#plt.tight_layout()
#plt.savefig('./figs/redarr_noise.pdf')
...
ax2.set_xlabel( "$\gamma_o$", fontsize=axis_label_fontsize)
...
plt.legend(fontsize=14)
plt.xlim([0.023,0.036])
plt.ylim([0,1.1])
plt.tight_layout()
plt.savefig('./figs/redarr_offset.pdf')
...
plt.ylim([0,1.1])
plt.tight_layout()
plt.savefig('./figs/redarr_xo.pdf')
...
ax4.set_xlabel( "$\gamma_o$", fontsize=axis_label_fontsize)
...
plt.ylim([0,1.1])
plt.tight_layout()
plt.savefig('./figs/redarr_temp.pdf')
...
plt.ylim([0,1.1])
plt.tight_layout()
plt.savefig('./figs/redarr_data.pdf')
