...
#  print(type(gamma_sub_data))
  ...
  gcn = ax2.acorr(gamma_sub_data[:,0]-np.mean(gamma_data[burnin_length:]), usevlines=False, maxlags=None, normed=True, lw=2, linestyle='-', marker='.',color='red', label=r"$\gamma0$")
